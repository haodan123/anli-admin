...
var pvpHeader = (function () {
	...
	util.addHeaderHTML = function () {
		...
		headerHTML += '      <h1><a href="//pvp.qq.com/" class="logo pa" title="王者荣耀" onclick="PTTSendClick(\'link\',\'logo\',\'logo\');">王者荣耀</a></h1>';
		headerHTML += '      <!--=========主导航==========-->';
		...
		headerHTML += '             <a href="/ip/index.html?adtag=pvp.pc" target="_blank" title="世界观体验站" onclick="PTTSendClick(\'link\',\'data_story\',\'世界观体验站\');"><i class="icon-fans"></i>世界观体验站</a>';
		...
		headerHTML += '             <a href="https://pvp.qq.com/cp/a20220914wza/" target="_blank" title="手语打法参考" onclick="PTTSendClick(\'link\',\'wza\',\'手语打法参考\');"><i class="icon-fans"></i>手语打法参考</a>';
		headerHTML += '          </li>';
		headerHTML += '          <li class="down-nav">';
		headerHTML += '             <a href="/cp/kic2022/index.html " target="_blank" title="世界冠军杯" onclick="PTTSendClick(\'link\',\'match_worldcup\',\'世界冠军杯\');"><i class="icon-hot"></i>世界冠军杯</a>';
		headerHTML += '             <a href="/match/WCC/KCC2022S1/index.html" target="_blank" title="挑战者杯" onclick="PTTSendClick(\'link\',\'match_kcc\',\'挑战者杯\');">挑战者杯</a>';
		headerHTML += '             <a href="/match/kpl/kingproleague/index.html" target="_blank" title="KPL职业联赛" onclick="PTTSendClick(\'link\',\'match_KPL\',\'KPL\');">KPL</a>';
		...
		headerHTML += '             <a href="/matchdata/index.html" target="_blank" title="赛事数据" onclick="PTTSendClick(\'link\',\'match_datamore\',\'赛事数据\');">赛事数据</a>';
		...
		headerHTML += '             <a href="//igame.qq.com/newcss/pvp/privilegePC/index.html" target="_blank" title="商户特权" onclick="PTTSendClick(\'link\',\'wifi\',\'商户特权\');">商户特权</a>';
		...
		headerHTML += '          </li>';
		headerHTML += '          <li class="down-nav">';
		headerHTML += '            <a href="//pvp.qq.com/hdy/p1/index.html" title="创意互动营" onclick="PTTSendClick(\'link\',\'creative_community\',\'创意互动营\');"><i class="icon-hot"></i>创意互动营</a>';
	...
	util.setKVLink = function () {
		...
		$.getScript("//pvp.qq.com/webplat/info/news_version3/15592/29030/29082/38446/m11738/index.js", function () {
	...
	init = function () {
		function n() {
			...
			//载入PC官网SEO统计组件
			fn.jsLoader("//game.gtimg.cn/images/yxzj/web201706/js/pvppc.js");
		...
		var libFile = (window.milo) ? "" : "//game.gtimg.cn/images/js/milo/milo.js"
